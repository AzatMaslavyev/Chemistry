...
using UnityEditor;
using UnityEngine;
[CreateAssetMenu(fileName = "CheckingTheFix", menuName = "State(Check)/CheckingTheFix")]
public class CheckingTheFix : ScenarioAction {
    ...
    public override void DrawNodeWindow(int id)
    {
        ...
        GUILayout.Label("Penality score if fix: ");
